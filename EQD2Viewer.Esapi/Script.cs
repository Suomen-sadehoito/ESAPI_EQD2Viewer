 ...
 try
   ...
   IImageRenderingService renderingService = new ImageRenderingService();
    ...
    // Summation data loader for on-demand plan loading
           ISummationDataLoader summationLoader = new EQD2Viewer.Esapi.Adapters.EsapiSummationDataLoader(context.Patient);
      ...
      renderingService.Initialize(width, height);
        ...
        // Use the snapshot-based constructor with summation support
